...
# class Mydatabase:
# 	def __init__(self):
# 		self.engine = get_database_engine(True)
...
# 	print(table)
# 	conn = engine.connect()
# 	s = select([table]).where(table.c.timestamp.between(begin_timestamp, end_timestamp))
...
# # result = query_data("btc", "blockcount", DBSession, 0, 123)
# # print(result)
